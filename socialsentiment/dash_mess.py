...
@app.callback(Output('recent-tweets-table', 'children'),
              [dash.dependencies.Input(component_id='sentiment_term', component_property='value'),dash.dependencies.Input('recent-table-update', 'interval')]
              )        
...
@app.callback(Output('sentiment-pie', 'figure'),
              [dash.dependencies.Input(component_id='sentiment_term', component_property='value'),dash.dependencies.Input('sentiment-pie-update', 'interval')]
              )
...
@app.callback(Output('live-graph', 'figure'),
              [dash.dependencies.Input(component_id='sentiment_term', component_property='value'),dash.dependencies.Input('graph-update', 'interval')]
              )
...
@app.callback(Output('historical-graph', 'figure'),
              [dash.dependencies.Input(component_id='sentiment_term', component_property='value'),dash.dependencies.Input('historical-update', 'interval')]
              )
...
@app.callback(Output('related-sentiment', 'children'),
              [dash.dependencies.Input(component_id='sentiment_term', component_property='value'),dash.dependencies.Input('related-update', 'interval')]
              )
